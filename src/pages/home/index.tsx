...
import { Container, StartContainer, TrendingContainer, Books, BookCardImage, Description, BookCard, ListBookCard, BookContent, SeeAllLink, TitleContainer, BookImage, AvatarImage } from "./styles";
